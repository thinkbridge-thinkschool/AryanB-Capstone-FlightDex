...
/// <summary>
/// A booked ticket owned by a <see cref="User"/>. The origin/destination airport details and the
/// passenger's name + age are snapshotted onto the ticket at booking time so it stays a faithful
